...
class FFWBG2BaseMimicEnv(ManagerBasedRLMimicEnv):
    """Isaac Lab Mimic environment wrapper for the FFW_BG2 base LED-search task."""
    ...
    def target_eef_pose_to_action(
        ...
        # Reuse the auxiliary-action slot to preserve both gripper and head commands during Mimic replay.
    ...
    def get_object_poses(self, env_ids: Sequence[int] | None = None):
        ...
        if led_target_anchor_pose is not None:
            ...
            if not getattr(self, "_warned_missing_led_target_anchor", False):
                print(
                    "[FFWBG2BaseMimicEnv] LedTargetAnchor was not found in the stage; "
    ...
    def _get_search_done_signals(self) -> torch.Tensor:
        """Infer when the arm has started leaving the search phase."""
